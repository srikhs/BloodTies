<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="FindMatches.aspx.cs" Inherits="Default2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="col_2">
    <asp:Panel runat="server" Width="700px">
         <asp:Panel runat="server" Width="700px">
                 <asp:Button ID="AdvanceSearch12" runat="server" Text="ADVANCE SEARCH" Font-Bold="true" ToolTip="Click to Refine Search Results" OnClick="AdvanceSearch_Click"/>
            <asp:RadioButtonList ID="SearchRadioList12" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow" ValidateRequestMode="Enabled" BorderStyle="Groove" Width="470px">
                <asp:ListItem Text="Personality Traits" Value="Personality_Traits"></asp:ListItem>
                <asp:ListItem Text="Illness Type" Value="Illness_Type"></asp:ListItem>
                <asp:ListItem Text="Location" Value="Location"></asp:ListItem>
                <asp:ListItem Text="All" Value="All"></asp:ListItem>
             </asp:RadioButtonList>
             </asp:Panel>
         <asp:Label ID="Warning_Message12" Visible="false" runat="server"></asp:Label>
    </asp:Panel>
   </div>
